...
module COBALT_send_diag
  ...
  use g_tracer_utils, only : g_tracer_get_values,g_tracer_get_pointer
  use g_tracer_utils, only : g_tracer_set_values

  implicit none; private
  public cobalt_send_diagnostics
  public cobalt_send_diagnostics_bottom
...
!==============================================================================================================
    ...
    !> subroutine that handles send_diag calls for bottom fluxes      
    subroutine cobalt_send_diagnostics_bottom(tracer_list,model_time,grid_tmask,temp_field,dt,&
                                 isc,iec,jsc,jec,isd,jsd,phyto,cobalt)
      type(g_tracer_type),        pointer,       intent(in) :: tracer_list                   
      type(time_type),                           intent(in) :: model_time
      real, dimension(:,:,:),     pointer,       intent(in) :: grid_tmask
      real, dimension(:,:,:),     pointer,       intent(in) :: temp_field
      real,                                      intent(in) :: dt
      integer,                                   intent(in) :: isc
      integer,                                   intent(in) :: iec
      integer,                                   intent(in) :: jsc
    ...
    end subroutine cobalt_send_diagnostics_bottom  
