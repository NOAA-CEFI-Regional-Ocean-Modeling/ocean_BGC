...
module generic_COBALT
  ...
  use cobalt_glbl 
  use cobalt_send_diag, only : cobalt_send_diagnostics,cobalt_send_diagnostics_bottom
...
!            implementation='duce',   &
  ...
  subroutine generic_COBALT_update_from_bottom(tracer_list, dt, tau, model_time)
    ...
    !
    call cobalt_send_diagnostics_bottom(tracer_list,model_time,grid_tmask, &
                            temp_field,dt,isc,iec,jsc,jec,isd,jsd,phyto,cobalt)
